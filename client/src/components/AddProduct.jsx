...
const saveToDB = ()=>{
    Axios.post("http://localhost:3001/nuevoproducto",{nombre: nombre,id: id,precio: precio,stock: stock});
...
<label>Stock</label>
<input type="" id="stock" onChange={(event)=>{setStock(event.target.value);}}></input>
<label>Precio</label>
<input type="" id="stock" onChange={(event)=>{setPrecio(event.target.value);}}></input>
